...
if (!class_exists('EHXDo_Actions')) {
    ...
    class EHXDo_Actions
    {
        ...
        {
            $export = EHXDo_Helper::getInput('export');
            ...
            if ($export === 'edp-csv') {
                ...
                $page  = EHXDo_Helper::getInput('page');
        ...
        public function ehxdo_table_row_delete()
        {
            ...
            if(isset($table)) {
                ...
                $wpdb->query($wpdb->prepare("DELETE FROM %1s WHERE id = %d", $table, $id));
